...
loadSprite("bottomRight", "Tilset_DB.png");
loadSprite("topRight", "Tilset_DH.png");
loadSprite("middleRight", "Tilset_DM.png");
loadSprite("bottomLeft", "Tilset_GB.png");
loadSprite("topLeft", "Tilset_GH.png");
loadSprite("middleLeft", "Tilset_GM.png");
loadSprite("middleBottom", "Tilset_MB.png");
loadSprite("middleTop", "Tilset_MH.png");

loadSprite("leftDoor","openDoorLeft.png");
loadSprite("rightDoor","openDoorRight.png");
loadSprite("topDoor","openDoorTop.png");
loadSprite("botDoor","openDoorBot.png");

loadSprite("closeLeftDoor","closedDoorLeft.png");
loadSprite("closeTopDoor","closeTopDoor.png");
loadSprite("closeRightDoor","closeRightDoor.png");
loadSprite("closeBotDoor","closeBotDoor.png");

loadSprite("leftExit","openExitLeft.png");
loadSprite("rightExit","openExitRight.png");
loadSprite("topExit","openExitTop.png");
loadSprite("botExit","openExitBot.png");

loadSprite("chest","openChest.png");
loadSprite("ground","ground.png");

loadSprite("playerBack", "player.png");
loadSprite("playerFront", "playerFront.png");
loadSprite("playerLeft", "playerLeft.png");

loadSprite("bat", "bat.png");
